...
all: ./bin/boot.bin ./bin/kernel.bin user_programs
	...
	docker run --privileged -v ./bin/os.bin:/os.bin -v ./hello.txt:/hello.txt -v ./programs:/programs --rm peachos-mount
...
./build/loader/formats/elf.o: ./src/loader/formats/elf.c
	i686-elf-gcc $(INCLUDES) -I./src/loaders/formats $(FLAGS) -std=gnu99 -c ./src/loader/formats/elf.c -o ./build/loader/formats/elf.o

./build/loader/formats/elfloader.o: ./src/loader/formats/elfloader.c
	i686-elf-gcc $(INCLUDES) -I./src/loaders/formats $(FLAGS) -std=gnu99 -c ./src/loader/formats/elfloader.c -o ./build/loader/formats/elfloader.o
